      ...
      <div class="row">
        <div class="col s4">
          <Select
            ...
            isOpen={isOpen}
            defaultValue={defaultValue ? defaultValue.slice(8,10) : null}
          />
        ...
        <div class="col s4">
          <Select
            ...
            isOpen={isOpen}
            defaultValue={defaultValue ? defaultValue.slice(5,7) : null}
          />
        ...
        <div class="col s4">
          <Select
            ...
            isOpen={isOpen}
            defaultValue={defaultValue ? defaultValue.slice(0,4) : null}
          />
