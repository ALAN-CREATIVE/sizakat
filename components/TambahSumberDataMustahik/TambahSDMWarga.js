...
export default function FormTambahSDMWarga() {
  ...
  const [
    ...
    onCompleted: (createDataWarga) => {
      ...
      if (createDataWarga.dataSourceWargaMutation.errors.length !== 0) {
        ...
        setFailed(true);
        console.log(
          createDataWarga.dataSourceWargaMutation.errors[0].messages[0]
        );
      } else {
        // createSDM({
        //   variables: {
  ...
  const handleSubmit = () => {
    ...
    if (dataSourceWarga.picName.match(symbol.onlySpace)) {
      ...
      temporaryError.picName =
        "Nama penanggung jawab tidak boleh diisi spasi saja";
    }
    ...
    if (
      dataSourceWarga.picKtp.length < 14 ||
      dataSourceWarga.picKtp.length > 14
    ) {
      formIsValid = false;
    ...
    if (dataSourceWarga.picKtp.match(symbol.alphabet)) {
      formIsValid = false;
    ...
    if (
      dataSourceWarga.picPhone.match(symbol.phoneNumberWithSymbol) ||
      dataSourceWarga.picPhone.match(symbol.onlySymbol)
    ) {
      formIsValid = false;
      temporaryError.picPhone =
        "Format nomor telepon harus berupa angka yang diawali dengan 0 (Contoh: 0811111111)";
    }
    ...
    if (dataSourceWarga.picPosition.match(symbol.onlySpace)) {
      formIsValid = false;
      temporaryError.picPosition =
        "Jabatan penanggung jawab tidak boleh diisi spasi saja";
    }
    ...
    if (dataSourceWarga.regency.match(symbol.onlySpace)) {
      ...
      temporaryError.regency =
        "Nama kota/kabupaten tidak boleh diisi spasi saja";
    }
    ...
    if (dataSourceWarga.subDistrict.match(symbol.onlySpace)) {
      ...
      temporaryError.subDistrict =
        "Nama kecamatan tidak boleh diisi spasi saja";
    }
  ...
  //     if (
  //       createData &&
  //       createData.dataSourceMutation &&
  //       createData.dataSourceMutation.dataSource
  //     ) {
  //       createSDMWarga({
  //         variables: {
  //           input: {
  ...
  //     if (
  //       createDataWarga &&
  //       createDataWarga.dataSourceWargaMutation &&
  //       createDataWarga.dataSourceWargaMutation.dataSourceWarga
  //     ) {
  //       // router.push({
              ...
              onChange={(provinsi) => {
                ...
                if (provinsi.match(symbol.stringnumberValid)) {
                  ...
                  setError({
                    ...error,
                    province:
                      "Nama provinsi tidak boleh diisi dengan spasi saja",
                  });
                ...
                <TextField
                  ...
                  onChange={(kota) => {
                    ...
                    if (kota.match(symbol.stringnumberValid)) {
                      setError({ ...error, regency: "" });
                    } else if (kota.match(symbol.onlySpace)) {
                      setError({
                        ...error,
                        regency:
                          "Nama kota tidak boleh diisi dengan spasi saja",
                      });
                  ...
                  onChange={(kecamatan) => {
                    ...
                    if (kecamatan.match(symbol.stringnumberValid)) {
                      ...
                      setError({
                        ...error,
                        subDistrict:
                          "Nama kecamatan tidak boleh diisi dengan spasi saja",
                      });
                  ...
                  onChange={(kelurahan) => {
                    ...
                    if (kelurahan.match(symbol.stringnumberValid)) {
                      ...
                      setError({
                        ...error,
                        village:
                          "Nama kelurahan tidak boleh diisi dengan spasi saja",
                      });
                ...
                <TextField
                  ...
                  onChange={(rw) => {
                    ...
                    if (rw.match(symbol.numberValid)) {
                      ...
                      setError({ ...error, rw: "Nomor RW tidak boleh kosong" });
                    } else {
                      setError({ ...error, rw: "" });
                    }
                  }}
                ...
                <TextField
                  ...
                  onChange={(rt) => {
                    ...
                    if (rt.match(symbol.numberValid)) {
                      ...
                      setError({ ...error, rt: "Nomor RT tidak boleh kosong" });
                    } else {
                      setError({ ...error, rt: "" });
                    }
                  }}
          ...
          <div className="form" id="nama">
            <TextField
              ...
              onChange={(penanggungjawab) => {
                setDataSourceWarga({
                  ...dataSourceWarga,
                  picName: penanggungjawab,
                });
                if (penanggungjawab.match(symbol.namaLengkapValid)) {
                  setError({ ...error, picName: "" });
                } else if (penanggungjawab.match(symbol.onlySpace)) {
                  setError({
                    ...error,
                    picName:
                      "Nama penanggung jawab tidak boleh diisi dengan spasi saja",
                  });
            ...
            <TextField
              ...
              onChange={(jabatan) => {
                ...
                if (jabatan.match(symbol.stringnumberValid)) {
                  setError({ ...error, picPosition: "" });
                } else if (jabatan.match(symbol.onlySpace)) {
                  setError({
                    ...error,
                    picPosition:
                      "Jabatan penanggung jawab tidak boleh diisi dengan spasi saja",
                  });
