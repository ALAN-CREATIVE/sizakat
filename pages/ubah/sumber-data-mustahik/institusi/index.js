...
function App({ backend_uri }) {
    ...
    <ApolloProvider client={client}>
        <div className="Edit SDM Mustahik">
            <Head>
                <title>Edit Sumber Data Mustahik</title>
                <meta charset="utf-8" />
            ...
            <main>
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        <p id="breadcrumb">SDM {'//'} <span>Edit Sumber {'//'}</span><span style={{ color: "#00239D" }}><b>Institusi</b></span></p>
                        <FormTambahSDM />
